...
$this->params['pageControls']['items'][] = [
  ...
  'url' => ['/admin/good-user-coupons/create', 'id' => $model->getModel()->id, 'typeId' => GoodUserCoupon::TYPE_ID_FINISH, 'suffix' => '.js'],
  'icon' => 'fa-plus',
...
$this->params['pageControls']['items'][] = [
  ...
  'url' => ['/admin/good-user-coupons/create', 'id' => $model->getModel()->id, 'typeId' => GoodUserCoupon::TYPE_ID_BETWEEN, 'suffix' => '.js'],
  'icon' => 'fa-plus',
  'class' => 'js-remote-link',
];
