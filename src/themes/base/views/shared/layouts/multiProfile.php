...
$parts[] = [
    ...
    'items' => [
      ['title' => \Yii::t('app/profile', 'Nav Contacts'),'url' => Url::toRoute('/account/user-contacts'), 'icon' => 'fa-book'],
        ...
        ['title' => \Yii::t('app/profile', 'Nav Bills'), 'url' => Url::toRoute('/account/bills'), 'icon' => 'fa-credit-card'],
...
if ($user->isAdmin) {
    $parts[] = [
        ...
        'items' => [
          ...
          ['url' => Url::toRoute('/admin/bills'), 'title' => \Yii::t('app/admin', 'Nav Bills'), 'icon' => 'fa-credit-card'],
